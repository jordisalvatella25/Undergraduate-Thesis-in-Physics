...
This directory contains the ***TCellExpansionOnActivatingSurface*** simulation, designed to study **T Cell proliferation via contact-dependent activation, growth and mitosis on an adhesive flat surface**.
